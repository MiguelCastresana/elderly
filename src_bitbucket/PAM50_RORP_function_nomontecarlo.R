...
for(i in 1:length(data_clean)){
  ...
  dir.create("data_bitbucket/PAM50_ROR_P/PAM50_results_nomontecarlo/")
  
  dir.create(paste("data_bitbucket/PAM50_ROR_P/PAM50_results_nomontecarlo/",groups[i],sep = ""))
  
  
  ## Save
  write.table(GEX_pam50, paste("data_bitbucket/PAM50_ROR_P/PAM50_results_nomontecarlo/",
  ...
  inputDir <- paste("data_bitbucket/PAM50_ROR_P/PAM50_results_nomontecarlo/",groups[i],sep = "")  # the location of the data matrix, and where output will be located
