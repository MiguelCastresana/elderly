...
merge_function = function(){
  ...
  sub = final_dat[which(!is.na(final_dat[,5])  & final_dat$dataset%in%datasets_to_select & final_dat$age_at_initial_pathologic_diagnosis>=55 & final_dat$age_at_initial_pathologic_diagnosis<=65 
